...
An earlier mainnet deploy at `0x2B638dFEFa…1c5C` was paused and abandoned when Celo Proof of Ship attribution rules required deployment from the registered address. `bountyCount` was 0 and no cUSD was ever deposited.
